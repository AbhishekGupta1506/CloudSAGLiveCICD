...
def deployLatestBuildAssetAndConfigToCloudGIT(tenantName){
    ...
    try{
            ...
            for (int i = 1; i <= 3; i++) {
                ...
                dir("C:/CloudTransformation/SAGLiveWorkspace/CloudGIT/${tenantName}-${ISSolName}"){
                    ...
                    dir("C:/CloudTransformation/SAGLiveWorkspace/CloudGIT/${tenantName}-${ISSolName}/CC"){
                        ...
                        bat 'git config --global user.name "abg@softwareag.com"'
                        bat 'git add .'
        ...
        echo "Following exception occurs while deploying: \n\t\t\t ${e}"
                ...
                script{
                    ...
                    for(int i=0;i<10;i++){
                        ...
                        try{
                            ...
                            response = httpRequest authentication: 'cloudUsernamePassword', url: "https://siqa1.saglive.com/integration/clouddeployment/service/development/Sol2/Sol2IS/invoke/test:new_flowservice"

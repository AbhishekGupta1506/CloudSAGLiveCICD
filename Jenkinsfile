                        ...
                        script{
                            if (!fileExists('CloudAssetsBuild')) { 
                                ...
                                dir('C:/CloudTransformation/SAGLiveWorkspace/CloudAssetsBuild'){
                                    ...
                                    checkout([ $class: 'GitSCM', branches: [[name: '*/master']], extensions: [ [$class: 'CloneOption', noTags: true, reference: '', shallow: true] ], submoduleCfg: [], userRemoteConfigs: [[ credentialsId: 'cloudUsernamePassword', url: 'https://siqa1.saglive.com/integration/rest/internal/wmic-git/stage00-Sol2-Sol2UM']]])
                                }   
                            } 
                            else{
